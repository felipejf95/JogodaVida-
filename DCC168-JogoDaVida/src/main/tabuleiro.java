...
/*2.1.12*/	}
	...
	public boolean atualizarTabuleiro() {
...
public static void main (String []args){
			...
			System.out.println("Informe a quantidade interação que terá o jogo!");
			int numeroInteracao = ler.nextInt();
/*1*/		tabuleiro t = new tabuleiro(6,6);
/*1*/		System.out.println("Geracao inicial:");
/*1*/		t.imprimir();
/*1*/		for(int i=0; i <numeroInteracao; i++) {
